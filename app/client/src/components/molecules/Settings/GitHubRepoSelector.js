...
const GitHubRepoSelector = () => {
    ...
    const handleToggleRepo = async (accountId, repoId) => {
        try {
            ...
            // await instance.post("/api/github/repos/toggle", { accountId, repoId });
    ...
    return (
        <div className="flex w-full flex-col p-2 max-h-[85vh] overflow-hidden">
            ...
            <div className="flex items-center gap-5 mb-8 bg-[#1c1c1c] p-6 rounded-2xl border border-gray-800 shadow-xl overflow-hidden relative group shrink-0">
                <div className="absolute right-0 top-0 h-full w-24 bg-gradient-to-l from-purple-600/5 to-transparent"></div>
                <div className="flex h-14 w-14 items-center justify-center rounded-xl bg-purple-600/10 text-purple-400 border border-purple-500/30 group-hover:scale-105 transition-transform duration-300">
                ...
                <div className="z-10">
                    ...
                    <p className="text-[10px] text-purple-400 font-bold uppercase tracking-[2px] mt-0.5">Connected Repositories</p>
                </div>
            </div>
                                ...
                                <div className="flex flex-col items-end min-w-[100px]">
                                    ...
                                    <label className="inline-flex items-center cursor-pointer scale-110">
                                        <input
                                            ...
                                            onChange={() => handleToggleRepo(activeAccount, repo.id)}
