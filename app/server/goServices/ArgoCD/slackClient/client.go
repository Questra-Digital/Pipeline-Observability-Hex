...
import (
	...
	"github.com/QuestraDigital/goServices/ArgoCD/slackClient/protos"
)
...
func SendAlert() {
	...
	botToken := "xoxb-6246363538144-6208982571575-ixXGCgFwovJJyHpa0M3xwFOl"
	channelID := "C0664RSD6KZ"
	messageText := "Hello from gRPC client!"
